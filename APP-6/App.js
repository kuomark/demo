...
function MyHomeStack() {
  return (
    ...
    >
      <Stack.Screen name="風景照片" component={HomeScreen} />
      <Stack.Screen name="HomeDetailScreen" component={HomeDetailScreen} options={{ title: '風景圖片' }} />
    </Stack.Navigator>
  )
...
export default function App() {
  ...
  return (
    ...
    <NavigationContainer>
      ...
      >
        <Tab.Screen name="風景圖片" component={MyHomeStack} />
